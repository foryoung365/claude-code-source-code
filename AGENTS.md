...
This is the **Codex v2.1.88** source code, extracted from the npm package `@anthropic-ai/Codex`. It is a TypeScript/React-based CLI application that provides an AI-powered programming assistant.
...
│                 │ │                 │ │                 │
│ Tool Interface  │ │ api/Codex.ts   │ │ AppState Store  │
...
| `src/bridge/` | Codex Desktop / IDE bridge integration |
